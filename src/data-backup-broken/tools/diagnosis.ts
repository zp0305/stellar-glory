...
const physicsQuestions: DiagnosisQuestion[] = [
  // D1 基础
  {
    ...
    difficulty: 'D1',
    topic: '运动与速度',
    question: '物体做匀速直线运动，速度为5 m/s，3秒内通过的位移为多少？',
  ...
  // D2 进阶
  {
    ...
    difficulty: 'D2',
    topic: '牛顿第二定律',
    question: '质量为2 kg 的物体受到10 N 的合力，产生加速度为多少m/s²？',
  ...
  },
  {
    ...
    difficulty: 'D2',
    topic: '能量守恒',
    question: '一个质量1 kg 的物体从 5 m 高处自由下落，着地时动能约为多少 J？（g=10 m/s²）',
...
const chemistryQuestions: DiagnosisQuestion[] = [
  {
    ...
    difficulty: 'D1',
    topic: '原子结构',
    question: '氧原子的核电荷数为8，则氧离子O²⁻的核外电子数为？',
    options: ['6', '8', '10', '16'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    difficulty: 'D2',
    topic: '氧化还原',
    question: '在反应Zn + CuSO₄ → ZnSO₄ + Cu 中，被氧化的物质是？',

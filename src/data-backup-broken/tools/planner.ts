...
export const gradeLevels: GradeLevel[] = [
  {
    ...
    milestones: [
      ...
      { id: 'm3', label: '衔接学习', month: '7-8月', type: 'checkpoint', description: '预习高一数理化基础内容' },
  ...
  },
  {
    ...
    milestones: [
      ...
      { id: 'm2', label: '强基计划报名', month: '4月', type: 'decision', description: '强基计划校考准备' },
...
export const learningGoals: LearningGoal[] = [
  ...
  },
  {
    ...
    targets: [
      ...
      { grade: '高三', label: '双轨并行期', description: '强基校考与高考课内双线备考', metrics: ['强基入围', '高考成绩稳定'] },
    ],
  },
  {
    id: 'competition',
    ...
    targets: [
      ...
      { grade: '高三', label: '收官期', description: '决赛冲刺，冲刺金牌/银牌', metrics: ['决赛获奖', '保底强基优惠'] },
    ],
  },
]

...
const entry = {
  ...
  path: [
    "Step1：光电方程：E = hν - W₀（遏止电U_c = E_max/e", "Step2：极限频ν₀ = W₀/h（低于此频率无论光强多大都不发生光电效应", "Step3：最大初动能：E_km = eU_c = hν - hν₀",
    "Step4：光强决定光子数量（影响饱和光电流），频率决定能否发生光电效",
  ],
  variationWarning: "",
  ...
  essence: "光电效应：光子能= 逸出+ 动能。频率不够，能量不足，再强光也没用",
}

...
const entry = {
  ...
  thinkingMethod: "",
  level: "J",
  trigger: "系统有加速度（电车厢），在非惯性系中分析力学问",
  path: [
    "Step1：在非惯性系中，引入惯性力 F_i = -m·a₀（方向与加速度相反", "Step2：等效重力加速度 g' = g - a₀（在加速升降的电梯中）",
    "Step3：在加速车厢中：等g' 方向不竖直，物体平衡位置会改", "Step4：结合平衡条件或牛顿第二定律分析，静止时 F = 0",
  ],
  variationWarning: "",
  ...
  essence: "非惯性系：引F_i = -ma₀，之后就可以用常规力学方法处理",
}

...
const entry = {
  ...
  path: [
    "Step1：识别谁是电源：切割磁感线的导体棒内部是非静电力方向", "Step2：感应电动势：E = BLv（导体棒垂直切割；若不垂直，E = BLv sinθ", "Step3：把导体棒当成电源，内阻r，判断电流方向（右手定则或楞次定律）", "Step4：其余部分当成外电路，按闭合电路欧姆定律分析",
  ],
  variationWarning: "",
  ...
  essence: "切割磁感= 电源，E = BLv sinθ（B v 的夹角）。方向用右手定则",
}

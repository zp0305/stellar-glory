export const LEVEL_OPTIONS = [
  ...
  { value: 'L2', label: 'L2 模型', desc: '套路套用' },
...
export const FUNCTION_OPTIONS = [
  { value: 'DIAG', label: '诊断', desc: '检测掌握度' },
  { value: 'PRACTICE', label: '巩固', desc: '重复训练' },
  { value: 'VARIATION', label: '变式', desc: '条件变化' },
  { value: 'INTEGRATED', label: '综合', desc: '多知识混合' },
  { value: 'REAL', label: '真题', desc: '考试原题' },
  { value: 'METHOD', label: '方法', desc: '一题多解' },
] as const
...
export const DIFFICULTY_D_OPTIONS = [
  ...
  { value: 5, label: 'D5 高难', color: 'bg-red-100 text-red-600' },

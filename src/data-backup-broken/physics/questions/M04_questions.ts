...
export const M04_questions: Question[] = [
  ...
  // ===================== D2· 概念与辨认（B层） =====================
  {
    ...
    tags: ['易错'],
    hint: '注意追及和相遇的条件不同',
    question: '甲车以$v_1 = 10m/s$ 的速度匀速行驶，乙车在甲车后$x_0 = 20m$ 处，以$v_2 = 14m/s$ 的速度匀速追赶。\n\n下列判断正确的是（　）',
    options: [
      'A. 乙车一定能追上甲车',
      'B. 乙车一定追不上甲车',
      'C. 当乙车速度等于甲车时，两者距离最小',
    ...
    answer: 'C',
    explanation: `## 解析\n\n**分析 A、B 选项**\n乙车初速度 $v_2 = 14m/s > v_1 = 10m/s$，且加速度 $a_乙= 0$（匀速），速度始终大于甲车，初始距离20m。\n\n相对速度$\\Delta v = 4m/s$，乙车以相对速度 $4m/s$ 接近，所需时间：\n$$t = \\frac{x_0}{\\Delta v} = \\frac{20}{4} = 5s$$\n\n5秒后追上，A 正确，B 错误。\n\n**分析 C 选项**\n速度相等时，两车相对速度为零，距离不再减小，此后乙车速度超过甲车，距离开始增大。\n\n速度相等瞬间，两者距离最小。C 正确。\n\n**分析 D 选项**\n乙车速度大于甲车时，距离减小；但速度相等之前，乙车速度已大于甲车，距离已经开始减小。\nD 当乙车速度大于甲车时，距离减小"——减小发生在 $v_乙> v_甲$ 后，C 速度相等时距离最小更精确。\n\n**答案：C**`",
  ...
  // ===================== D3· 分析与应用（J层） =====================
  {
    ...
    question: '甲车以$v_0 = 20m/s$ 匀速行驶，乙车在甲车后$d = 50m$ 处。当 $t = 0$ 时，甲车刹车，加速度 $a_甲= 5m/s^2$；同时乙车以 $v_乙= 10m/s$ 匀速行驶。\n\n求：两车相撞时乙车的位移',
    options: null,
    answer: '20m',
    explanation: `## 解析\n\n**第一阶段：甲刹车，乙匀速**\n\n甲车刹车至停止的时间：\n$$t_停= \\frac{v_0}{a_甲} = \\frac{20}{5} = 4s$$\n\n停止前甲的位移：\n$$s_甲= v_0 t_停- \\frac{1}{2}a_甲t_停^2 = 20 \\times 4 - \\frac{1}{2} \\times 5 \\times 16 = 40m$$\n\n乙在 4s 内的位移：\n$$s_乙= v_乙t_停= 10 \\times 4 = 40m$$\n\n**第二阶段：判断是否相撞**\n\n甲停止时，两车距离：\n$$\\Delta s = d + s_甲- s_乙= 50 + 40 - 40 = 50m$$\n\n甲停止后，乙继续行驶追上：\n$$t_追= \\frac{\\Delta s}{v_乙} = \\frac{50}{10} = 5s$$\n\n乙总位移：\n$$s_乙总= v_乙(t_停+ t_追) = 10 \\times (4 + 5) = 90m$$\n\n**答案：90m**`,

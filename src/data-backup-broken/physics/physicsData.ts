...
export const physicsVisionStories = [
  ...
  { id: 'frontier-001', title: '暗物质：宇宙85%的存在', category: '前沿', difficulty: '🔴', readTime: 18 },
  ...
  { id: 'myth-001', title: '越用力推，物体会不会越快？', category: '谜题', difficulty: '🟡', readTime: 10 },

...
export const M06 = {
  ...
  positioning: {
    ...
    essence: "v物<v带>摩擦力向物体加速方向; v物>v带>摩擦力向物体减速方向; 共速>摩擦力消失",
    keyInsight: "传送带问题要分阶段分析，每阶段共速后重新判断摩擦力方向",
  },

  principle: "判断流程: 第一步比较v物和v带速度; 第二步物体做匀变速运动v(t)=v0+/-at (a=ug); 第三步找到共速时刻v(t)=v带时 a->0. 水平传送带加速度公式 a=ug * sign(v带-v物)",

  variations: {
    basic: [
      { label: "水平传送带(v物<v带)", formula: "物体加速到v带，摩擦力向前", note: "注意共速后摩擦力消失" },
  ...
  methodology: {
    approach: "三步法：1.判断初始摩擦力方向 -> 2.列牛顿方程 -> 3.找共速时刻 -> 4.新阶段重新分析",
    decisionTree: [
      "v物<v带 -> 摩擦力向前加速 -> 追踪v(t)", "v物>v带 -> 摩擦力向后减速 -> 追踪v(t)",
      "v物=v带 -> 摩擦为0", "v(t)=v带 -> 共速，之后匀速",
    ],
    commonPitfalls: [
      "忘记摩擦力方向可能变化--以为物体一直受固定方向的摩擦力", "共速后没有重新分析--以为一直加速或减速",
  ...
  selfCheck: {
    questions: [
      ...
      { q: "v物=5m/s，v带=3m/s，物体能追上传送带速度", a: "能，减速到3m/s后匀速", type: "进阶" },
    ],
    confidenceLevel: 3,
  },

...
export const M03 = {
  ...
  variations: {
    ...
    advanced: [
      { label: "多阶段", formula: "上升+自由落体分段处理", note: "找速度衔接" },
      { label: "经过同一点两次", formula: "利用对称性判断时间", note: "易错题" },
    ],
    challenge: [
  ...
  methodology: {
    ...
    decisionTree: [
      "问最大高度？-> H=v₀²/(2g)", "问时间？-> 先判断是否到达最高点",
      "问速度？-> 注意正负号",
    ],
    commonPitfalls: [
      "忘记正方向导致g符号错误", "忽略位移和高度的区别",
      "经过同一点的时间有两解，只算了一个",
    ],
  },
  ...
  selfCheck: {
    questions: [
      { q: "20m/s向上抛出一石子，求最大高度和落回时间", a: "H=20.4m，t=4.1s", type: "基础" },
      { q: "上抛物体，在t=1s和t=3s时经过同一点，求v₀", a: "v₀=g(t1+t2)/2=19.6m/s", type: "进阶" },
    ],
    confidenceLevel: 2,
  },

...
export const M02 = {
  ...
  variations: {
    ...
    advanced: [
      ...
      { label: "经过某点上下时间", formula: "Δt=2v/g", note: "经过同一点上升和下降的时间差" },
    ],
    challenge: [
      { label: "相对运动", formula: "选取不同参考系", note: "难度最大的一种" },
    ],
  },
  ...
  methodology: {
    ...
    decisionTree: [
      "初速度=0且只受重力？->自由落体（v=gt，h=½gt²）", "有初速度向上抛出？->竖直上抛（v=v₀-gt）",
      "经过同一点？->利用对称性：上升时间=下落时间",
    ],
    commonPitfalls: [
      "忘记竖直上抛正方向：向上为正则g取负", "混淆高度h和位移x：竖直上抛中h是相对于抛出点的高度",
      "忘记判断物体是否回到原位",
    ],
  },
  ...
  selfCheck: {
    questions: [
      ...
      { q: "竖直上抛物体初速度20m/s，求最大高度", a: "h=v₀²/(2g)=400/(2×9.8)=20.4m", type: "基础" },
      { q: "物体从塔顶自由下落，最后1秒下落高度为25m，求塔高", a: "设总时间t，½gt²-½g(t-1)²=25→t=3.06s，h=46.7m", type: "进阶" },
    ],
    confidenceLevel: 2,
  },

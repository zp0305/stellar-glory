...
$$\\bar{v} = \\frac{v_0 + v}{2}, \\quad x = \\bar{v} \\cdot t$$`,
  ...
  variations: {
    basic: [
      ...
      { label: '刹车问题', formula: 'x_max = v0²/(2a)', note: '先判断 t_stop = v0/|a|' }],
    advanced: [
      { label: '含位移', formula: 'x = (v² - v0²)/(2a)', note: '不含时间t' },
      { label: '平均速度', formula: 'x = (v0+v)/2 × t', note: '先算平均速度' },
      { label: '推论', formula: 'Δx = aT²', note: '相邻相等时间间隔的位移差' }],
    challenge: [
      { label: '多段衔接', formula: 'v前段= v后段', note: '找速度衔接' },
  ...
  // 5. 方法论
  methodology: {
    approach: '有t用基本公式，无t用变形公式，位告知v0v用无t公式',
    decisionTree: [
      '有t ? v = v0 + at',
      '有x和v ? v² - v0² = 2ax',
  ...
  selfCheck: {
    questions: [
      { q: '汽车20m/s行驶，刹车加速度大小3m/s²，求刹车距离', a: 'x = v0²/(2a) = 400/6 = 66.7m', type: '基础' },
      { q: '物体做匀加速直线运动，初速度4m/s，加速度2m/s²，求第3秒位移', a: 'x = v0t + ½at² = 4×3 + ½×2×9 = 21m', type: '基础' },
      { q: '匀加速物体，第2秒位移6m，第4秒位移14m，求加速度', a: 'Δx = aT²，a = (14-6)/4 = 2m/s²', type: '进阶' }],
    confidenceLevel: 3
  },

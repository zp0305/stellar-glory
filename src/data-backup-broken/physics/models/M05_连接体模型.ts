...
export const M05 = {
  ...
  principle: "核心公式: 速度-时间关系 v=v0+at, 位移-时间关系 x=v0t+1/2at^2, 速度-位移关系 v^2-v0^2=2ax. 连接体分析流程：第一步判断加速度 (系统内各物体加速度相同用整体法，否则必须分别隔离)；第二步整体法求系统加速度 a=F/(m1+m2)；第三步隔离法求系统内力T=m1*a",
  ...
  variations: {
    ...
    advanced: [
      { label: "斜面连接", formula: "沿斜面建坐标，分解重力", note: "先正交分解再整体隔离" },
      { label: "连接摩擦", formula: "先判断是否相对滑动", note: "比较最大静摩擦和m*a" },
    ],
    challenge: [
  ...
  knowledgeNetwork: {
    ...
    related: [],
    coreFormula: "a=F/(m1+m2)",
  },

  methodology: {
    approach: "标准流程: 先整体法求a，再隔离其中一个物体求内力",
    decisionTree: [
      "问加速度? -> 整体法", "问绳子拉力T? -> 先整体求a，再隔离",
      "问相互作用力? -> 隔离法", "加速度不同? -> 必须隔离法分别分析",
    ],
    commonPitfalls: [
      "整体法把内力(绳子拉力)算进去了--内力不能出现在整体法方程", "隔离时选错研究对象--优先选受力最少的那个",
      "多物体时把加速度方向弄反--先确定正方向",
    ],
  },
  ...
  lifeApplication: "拔河是典型的连接体问题。两人通过绳子连接，脚与地面之间的摩擦力是外力。关键看哪方摩擦力更大，哪方就能赢。人的重力越大，对地压力越大，最大静摩擦越大，质量大惯性大不容易被拉走",
}
...
import { allModels, modelDataMap, ALL_MODEL_IDS, biologyModels } from './models';
...
function getModelChapters() {
  return biologyModels.map(chapter => ({
    id: chapter.chapter,
...
registerSubject('biology', {
  ...
  getGraphModels: () => biologyModels.map(chapter => chapter.models).flat(),
});
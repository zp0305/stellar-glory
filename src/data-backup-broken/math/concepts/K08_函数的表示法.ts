...
export const K08: ConceptData = {
  ...
  variations: {
    basic: [
      { label: '解析, note: '用公式表达函数关 },
      { label: '图像, note: '用平面直角坐标系中的曲线表达' }',
      { label: '列表, note: '用表格列出离散 },
    ],
    advanced: [
  ...
  selfEval: [
    { question: '如何y=f(x) 的图像得y=f(x-2)+1 的图像？', level: 'B', description: '右移2单位，上单位' },
  ],

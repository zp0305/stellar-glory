...
export const K04: ConceptData = {
  ...
  preCheck: [
    {
      question: '"x>0，则 x²>0"这个命题中，x>0 是 x²>0 的什么条件？',
  ...
  narrative: {
    ...
    derivation: 'p⇒q，则 p 是 q 的充分条件，q 是 p 的必要条件',
  ...
  formulas: [
    ...
    { name: '必要条件', formula: 'q⇒p', usage: 'q 是 p 的必要条件' },
    { name: '充要条件', formula: 'p⇔q', usage: '双向等价' },
  ],

  selfEval: [
    { question: '"四边形是平行四边形⇔四边形对角线互相平分"的什么条件？', level: 'B', description: '必要不充分条件' },
  ],

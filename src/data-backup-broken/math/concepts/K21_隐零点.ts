...
export const K21: ConceptData = {
  ...
  preCheck: [
    {
      question: '隐零点是指？',
      options: ['A. 无法用公式表示的零点', 'B. 函数图像上看不见的零, 'C. 复数范围内的零点', 'D. 不存在的零点']',
      answer: 'A',
  ...
  narrative: {
    context: '很多方程x·eˣ=1 无法用初等方法求解，但我们可以证明零点存在并估计其范围',
  ...
  variations: {
    ...
    advanced: [
      { label: '同构技, formula: 'xeˣ=x·eˣ=1', note: '构造相同结 },
    ],
    challenge: [
      { label: '隐零点代, note: '在需要时x₀ 表示零点' }',
    ],
  },

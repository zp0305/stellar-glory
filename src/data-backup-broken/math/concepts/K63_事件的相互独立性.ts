...
export const K63: ConceptData = {
  ...
  preCheck: [
    {
      question: 'P(AB)=P(A)P(B)，则 A B 是什么关系？',
  ...
  narrative: {
    ...
    derivation: 'A B 独立 P(AB)=P(A)P(B)',
  ...
  variations: {
    basic: [
      ...
      { label: '互斥', formula: 'P(A∪B)=P(A)+P(B)', note: '无公共部 }',
    ],
    advanced: [
      { label: 'n 个独立事, formula: 'P(A₁A..A=P(AP(A...P(A', note: '乘法公式' }',
    ],
    challenge: [
      { label: '条件概率与独, formula: 'P(B|A)=P(B) A B 独立', note: '独立性的等价条件' }',
    ],
  },
  ...
  selfEval: [
    { question: '独立事件与互斥事件的区别是？', level: 'B', description: '独立事件 P(AB)=P(A)P(B)，互斥事P(A∪B)=P(A)+P(B)' },
  ],

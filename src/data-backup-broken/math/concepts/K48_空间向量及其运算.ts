...
export const K48: ConceptData = {
  ...
  variations: {
    basic: [
      { label: '空间向量坐标', formula: 'a=(aaa', note: '三维坐标' },
      { label: '空间向量, formula: '|a|=a₁a₂a₃', note: '长度' }',
    ],
    advanced: [
      { label: '方向余弦', formula: 'cos α=a|a|', note: '与坐标轴夹角' },
    ],
    challenge: [
      { label: '向量在几何中的应, note: '证明平行垂直' }',
    ],
  },

  formulas: [
    { name: '空间向量, formula: '|a|=a₁a₂a₃', usage: '求长 },
  ],

  selfEval: [
    { question: '空间向量 (1,0,0) (0,1,0) 的数量积是？', level: 'A', description: '0' },
  ],

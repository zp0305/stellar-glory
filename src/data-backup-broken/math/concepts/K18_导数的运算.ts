...
export const K18: ConceptData = {
  ...
  preCheck: [
    {
      question: 'f(x)=x³+2x，则 f\'(x)=',
      options: ['A. 3x²+2', 'B. 3x²', 'C. x²+2', 'D. 3x+2'],
      answer: 'A',
      explanation: '逐项求导x³)\'=3x²2x)\'=2',
    },
  ],
  ...
  variations: {
    basic: [
      ...
      { label: '商求, formula: '(u/v)\'=(u\'v-uv\')/v²', note: '除法法则' }',
    ],
    advanced: [
    ...
    challenge: [
      { label: '高阶导数', formula: 'f\"(x)=(f\'(x))\'n阶导f⁽ⁿx)', note: '多次求导' },
    ],
  },

  formulas: [
    { name: '链式法则', formula: '[f(g(x))]\'=f\'(g(x))·g\'(x)', usage: '复合函数求导' },
    { name: '(x\'', formula: 'nxⁿ⁻¹', usage: '幂函数求 }',

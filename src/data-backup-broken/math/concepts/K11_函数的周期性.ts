...
export const K11: ConceptData = {
  ...
  preCheck: [
    {
      ...
      answer: 'D',
      explanation: '只知f(x+2)=f(x)，最小正周期可能2，或不存在（如常数函数）',
    },
  ],
  ...
  narrative: {
    ...
    derivation: 'f(x+T)=f(x) 对定义域内所x 成立，则 T 是周期',
    transfer: 'f(x) 的周期为 T，则 f(ax+b) 的周期为 T/|a|',
  },

  variations: {
    basic: [
      { label: '周期', formula: 'f(x+T)=f(x)', note: 'T 为周 }',
      { label: '最小正周期', note: '正周期中的最小 }',
    ],
    advanced: [
      { label: '周期运算', formula: 'f1 周期 T1，f2 周期 T2，则 f1±f2 周期T1,T2 的最小公倍数', note: '前提是存在最小公倍数' },
    ],
    challenge: [
      { label: '非最小正周期', note: '2T 也是周期' },
    ],
  },

  formulas: [
    { name: '周期定义', formula: 'f(x+T)=f(x)', usage: '判断周期 }',

...
export const K55: ConceptData = {
  ...
  preCheck: [
    {
      question: '双曲x²/16-y²/9=1 的焦点坐标是',
      options: ['A. (±4,0)', 'B. (±5,0)', 'C. (±3,0)', 'D. (±,0)'],
      answer: 'B',
  ...
  variations: {
    basic: [
      { label: '标准方程', formula: 'x²/a²-y²/b²=1', note: '焦点x  }',
      { label: '焦点', formula: '(±c,0)', note: 'c²=a²+b²' },
      { label: '渐近, formula: 'y=±(b/a)x', note: '双曲线的渐近 },
    ],
    advanced: [
      { label: '第二定义', formula: 'e=c/a>1', note: '离心率大' },
      { label: '焦半, formula: '|PF₁|=|e·x±a|', note: '双曲线上的点到焦点距 },
    ],
    challenge: [
      { label: '共轭双曲, formula: 'x²/a²-y²/b²=1 -x²/a²+y²/b²=1', note: '互为共轭' }',
    ],
  },

  formulas: [
    { name: '双曲线标准方, formula: 'x²/a²-y²/b²=1', usage: '标准形式' }',
    { name: 'a、b、c 关系', formula: 'c²=a²+b²', usage: '求焦 }',
  ],

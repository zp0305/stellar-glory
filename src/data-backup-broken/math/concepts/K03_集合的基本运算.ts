...
export const K03: ConceptData = {
  ...
  preCheck: [
    {
      question: '设A={1,2,3}, B={2,3,4}，则 A∩B=?',
      options: ['A. {1,4}', 'B. {2,3}', 'C. {1,2,3,4}', 'D. ∅'],
      answer: 'B',
      explanation: '交集是同时属于A和B的元素组成的集合',
    },
  ],
  ...
  narrative: {
    ...
    experiment: '用Venn图表示两个相交圆的阴影部分，分别表示并集、交集',
    concept: '交集、并集、补集是集合的三种基本运算',
    derivation: 'A∩B={x|x∈A且x∈B}；A∪B={x|x∈A或x∈B}；∁UA={x∈U且x∉A}',
  ...
  variations: {
    basic: [
      ...
      { label: '补集', formula: '∁UA', note: '相对于全集U' },
    ],
    advanced: [
      { label: '德·摩根定律', formula: '(A∪B)^C = A^C∩B^C', note: '交并补的转化' },
      { label: '分配律', formula: 'A∩(B∪C) = (A∩B)∪(A∩C)', note: '分配律' },
    ],
    challenge: [
  ...
  selfEval: [
    { question: '设A⊆B，则 A∩B 等于什么？', level: 'A', description: 'A' },
  ],

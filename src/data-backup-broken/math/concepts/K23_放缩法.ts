...
export const K23: ConceptData = {
  ...
  preCheck: [
    {
      question: '放缩法的本质是什么？',
      options: ['A. 将复杂式子化简', 'B. 将不易处理的量用易处理的量替, 'C. 消去未知, 'D. 求导'],
      answer: 'B',
  ...
  selfEval: [
    { question: '如何放缩证明 /n > ln(n+1), level: 'C', description: '利用 1/k > ln(k+1)-ln k' }',
  ],

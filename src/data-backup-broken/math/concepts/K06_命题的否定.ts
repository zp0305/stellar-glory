...
export const K06: ConceptData = {
  ...
  narrative: {
    ...
    derivation: 'p 为真则 ¬p 为假；p 为假则 ¬p 为真',
  ...
  variations: {
    basic: [
      ...
      { label: '且的否定', formula: '¬(p∧q) = ¬p∨¬q', note: '德·摩根定律' },
      { label: '或的否定', formula: '¬(p∨q) = ¬p∧¬q', note: '德·摩根定律' },
    ],
    advanced: [
  ...
  selfEval: [
    { question: '"p⇒q"为真时，"非p⇒非q"的真假是？', level: 'A', description: '假' },
  ],

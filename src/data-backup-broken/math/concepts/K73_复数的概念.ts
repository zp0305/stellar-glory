...
export const K73: ConceptData = {
  ...
  narrative: {
    ...
    concept: '复数形如 a+bi，其a,b∈R，i²=-1',
    derivation: 'a 称为实部，b 称为虚部。当 b=0 时为实数，当 b 时为虚数',
    transfer: '复数的模、共轭复数的概念',
  },

  variations: {
    basic: [
      { label: '复数形式', formula: 'z=a+bi', note: 'a 为实部，b 为虚 }',
      { label: '虚数单位', formula: 'i²=-1', note: '定义' },
    ],
    advanced: [
      { label: '复平, note: '复数与平面点的对 },
      { label: '共轭复数', formula: 'z=a+bi 的共轭是 a-bi', note: '记作 z̄' },
    ],
    challenge: [
      { label: '复数的模', formula: '|z|=a²+b²)', note: '复数的大 }',
    ],
  },

  formulas: [
    { name: '虚数单位', formula: 'i²=-1', usage: '复数定义' },
    { name: '复数, formula: '|z|=a²+b²)', usage: '求模 },
  ],

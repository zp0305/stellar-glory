...
export const K57: ConceptData = {
  ...
  preCheck: [
    {
      ...
      options: ['A. 一次方, 'B. 二次方程', 'C. 常数方程', 'D. 无法确定']',
      answer: 'B',
  ...
  narrative: {
    ...
    derivation: '联立方程组，消去一个变量，得到一元二次方程。0 相交，0 相切，0 相离',
  ...
  variations: {
    basic: [
      ...
      { label: '相切', formula: 'Δ=0', note: '一个切 }',
      { label: '相离', formula: 'Δ<0', note: '无交 }',
    ],
    advanced: [
  ...
  formulas: [
    { name: '判别, formula: 'Δ>0 相交，0 相切，0 相离', usage: '判断位置关系' }',
  ],

  selfEval: [
    { question: '判断直线与圆锥曲线位置关系用什么方法？', level: 'A', description: '联立方程组用判别 }',
  ],

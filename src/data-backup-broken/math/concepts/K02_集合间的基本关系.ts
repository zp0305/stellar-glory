...
export const K02: ConceptData = {
  ...
  preCheck: [
    {
      question: 'A⊆B 且 B⊆A，则 A 与 B 的关系是？',
      options: ['A. A∈B', 'B. A=B', 'C. A⊂B', 'D. 无法确定'],
      answer: 'B',
      explanation: 'A B 的子集且 B A 的子集，A=B，这是集合相等的定义',
    },
  ],
  ...
  narrative: {
    ...
    experiment: 'A={1,2,3}，B={1,2}，C={1,2,3}，判断包含关系。',
    concept: '子集、真子集、空集是集合的基本关系。',
    derivation: 'A⊆B ∀x∈A, x∈B；A⊂B A⊆B A≠B',
    transfer: 'Venn 图直观理解集合的包含关系',
  },

  variations: {
    basic: [
      { label: '子集', formula: 'A⊆B', note: 'A 中元素都属于 B' },
      { label: '真子集', formula: 'A⊂B', note: 'A⊆B 且 A≠B' },
      { label: '空集', formula: '∅', note: '没有元素的集合' },
    ],
    advanced: [
      { label: '集合相等', formula: 'A=B ⇔ A⊆B 且 B⊆A', note: '双向子集证明' },
      { label: '空集的性质', note: '∅⊆A 对任意集A 成立' },
    ],
    challenge: [
      { label: 'n元集合的子集', formula: '2^n', note: '包括空集和自身' },
    ],
  },

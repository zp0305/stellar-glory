...
export const K07: ConceptData = {
  ...
  narrative: {
    context: '在研究变量关系时，我们需要用精确的数学语言描述"依赖"对应关系',
  ...
  variations: {
    basic: [
      ...
      { label: '表示方法', formula: '解析法、图像法、列表法', note: '三种常见形式' },
    ],
    advanced: [
      { label: '相同函数', formula: '定义域和对应法则相同', note: '两个函数相等' },
  ...
  formulas: [
    { name: '函数定义', formula: 'f: A→B', usage: 'A 到 B 的对应' },
    { name: '函数表示', formula: 'y=f(x)', usage: 'x 对应 y' },
  ],

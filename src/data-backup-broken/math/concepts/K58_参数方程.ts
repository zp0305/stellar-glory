...
export const K58: ConceptData = {
  ...
  preCheck: [
    {
      question: '参数方程 x=cos θ, y=sin θ (θ 为参 表示什么曲线？',
      options: ['A. 直线', 'B. , 'C. 椭圆', 'D. 抛物],
      answer: 'B',
      explanation: 'cos²θ+sin²θ=1，所x²+y²=1，是单位圆',
    },
  ],
  ...
  narrative: {
    ...
    derivation: '常见参数方程：圆 x=a+r cos θ, y=b+r sin θ；椭x=a cos θ, y=b sin θ',
  ...
  variations: {
    basic: [
      ...
      { label: '椭圆的参数方, formula: 'x=a cos θ, y=b sin θ', note: '参数 θ' }',
    ],
    advanced: [
      { label: '抛物线的参数方程', formula: 'x=2pt, y=pt²', note: '参数 t' },
      { label: '直线的参数方, formula: 'x=x₀+lt, y=y₀+mt', note: '方向向量 (l,m)' }',
    ],
    challenge: [
      { label: '参数方程求轨, note: '消去参数得普通方 },
    ],
  },

  formulas: [
    { name: '圆参数方, formula: 'x=a+r cos θ, y=b+r sin θ', usage: '单位 },

...
export const K45: ConceptData = {
  ...
  variations: {
    basic: [
      { label: '线线关系', note: '相交、平行、异 }',
      { label: '线面关系', note: '平行、相交、在面内' },
      { label: '面面关系', note: '平行、相 }',
    ],
    advanced: [
      { label: '异面直线所成角', formula: '转化为相交直线所成角', note: '平移 }',
    ],
    challenge: [
      { label: '面面平行判定', formula: '线面平行⇒面面平, note: '传递 },
    ],
  },

  formulas: [
    { name: '异面直线所成角', formula: '范围 (0°, 90°]', usage: '求角 }',
  ],

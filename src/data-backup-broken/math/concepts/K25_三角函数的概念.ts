...
export const K25: ConceptData = {
  ...
  preCheck: [
    {
      question: '在单位圆中，P(cos θ, sin θ) 满足',
  ...
  narrative: {
    ...
    experiment: '在单位圆中标0°0°5°0°0° 对应的点的坐标',
    concept: '单位圆上任意角的终边与圆的交点坐标为 (cos θ, sin θ)',
    derivation: 'sin θ=y/r, cos θ=x/r, tan θ=y/x (x)',
  ...
  variations: {
    basic: [
      ...
      { label: '正切', formula: 'tan θ=sin θ/cos θ', note: '比 }',
    ],
    advanced: [
      { label: '三角函数, note: '有向线段表示三角函数 },
    ],
    challenge: [
      { label: '三角函数定义, note: 'tan θ θ≠π/2+kπ' }',
    ],
  },

  formulas: [
    { name: '同角三角函数', formula: 'sin²θ+cos²θ=1', usage: '基本关系' },
    { name: '正切定义', formula: 'tan θ=sin θ/cos θ', usage: '求正切 }',
  ],

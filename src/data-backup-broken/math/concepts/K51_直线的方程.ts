...
export const K51: ConceptData = {
  ...
  preCheck: [
    {
      question: '斜截y=kx+b 中，b 的几何意义是',
      options: ['A. 斜率', 'B. 截距', 'C. 倾斜, 'D. 过原],
      answer: 'B',
  ...
  variations: {
    basic: [
      { label: '斜截, formula: 'y=kx+b', note: '已知斜率和截 },
      { label: '点斜, formula: 'y-y₀=k(x-x₀)', note: '已知一点和斜率' }',
      { label: '一般式', formula: 'Ax+By+C=0', note: '通用形式' },
    ],
    advanced: [
      { label: '两点, formula: '(y-y/(yy=(x-x/(xx', note: '已知两点' }',
      { label: '截距, formula: 'x/a+y/b=1', note: '已知两截 },
    ],
    challenge: [
      { label: '方程的互, note: '不同形式之间的转 },
    ],
  },

  formulas: [
    { name: '斜截, formula: 'y=kx+b', usage: '已知斜率和截 },
    { name: '点斜, formula: 'y-y₀=k(x-x₀)', usage: '已知一点和斜率' }',
  ],

...
export const K43: ConceptData = {
  ...
  variations: {
    basic: [
      { label: '斜二测画法规, note: 'x 轴水平，y 轴成 45°' }',
      { label: '长度规则', formula: 'x 轴长度不变，y 轴长度减, note: '画法规则' }',
    ],
    advanced: [
      { label: '正等测画, note: '三个轴两两成 120°' }',
    ],
    challenge: [
      { label: '三视, note: '正视图、侧视图、俯视图' }',
    ],
  },

  formulas: [
    { name: '斜二测规, formula: 'x 不变，y 减半', usage: '画直观图' }',
  ],

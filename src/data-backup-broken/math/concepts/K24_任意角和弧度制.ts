...
export const K24: ConceptData = {
  ...
  preCheck: [
    {
      ...
      answer: 'C',
      explanation: '180°=π 弧度，所300°=300×π/180=5π/3',
    },
  ],
  ...
  narrative: {
    ...
    experiment: '0°0°5°0°0° 转化为弧度',
    concept: '任意角是起点相同、旋转量任意的角。弧度制以弧长与半径的比值为度量',
    derivation: '180°=π 弧度°=π/180 弧度 弧度=180/π 度',
    transfer: '弧度制下的三角函数公式更简洁',
  },

  variations: {
    basic: [
      { label: '角度转弧, formula: 'α(弧度)=α(×π/180', note: '换算关系' }',
      { label: '弧度转角, formula: 'α(=α(弧度)×180/π', note: '换算关系' }',
    ],
    advanced: [
      { label: '象限, note: '终边在第几象 },
      { label: '终边相同的角', formula: 'α+2kπ', note: 'k∈Z' },
    ],
    challenge: [
      { label: '弧度制优, note: 'sin x 的麦克劳林展开更简 },
    ],
  },

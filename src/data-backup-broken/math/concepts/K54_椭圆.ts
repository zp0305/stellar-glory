...
export const K54: ConceptData = {
  ...
  preCheck: [
    {
      ...
      options: ['A. (±4,0)', 'B. (±5,0)', 'C. (±3,0)', 'D. (±4,0)'],
      answer: 'A',
  ...
  variations: {
    basic: [
      { label: '标准方程', formula: 'x²/a²+y²/b²=1', note: 'a>b>0，焦点在 x  }',
      { label: '顶点', formula: '(±a,0), (0,±b)', note: '四个顶点' },
      { label: '焦点', formula: '(±c,0)', note: 'c²=a²-b²' },
    ],
    advanced: [
      { label: '第二定义', formula: 'e=c/a', note: '离心 }',
      { label: '焦半, formula: 'PFa+e·x PFa-e·x', note: '椭圆上一点到焦点距离' }',
    ],
    challenge: [
  ...
  selfEval: [
    { question: '椭圆 x²/16+y²/9=1 的离心率是？', level: 'A', description: '/4' },
  ],

...
export const L02: MathModel = {
  ...
  chapter: {
    id: 'L02',
    title: '充要条件与量',
    subtitle: '充分条件、必要条件、全称量词、存在量',
    module: '集合与逻辑',
    content: '充要条件和量词是逻辑推理的基础',
    examples: [
      {
        title: '判断条件',
        problem: 'x>0 x²>0 的什么条',
        solution: '充分不必要条',
        key: '推出关系',
      },
    ],
...
export const B04: MathModel = {
  ...
  chapter: {
    ...
    examples: [
      {
        title: '对应关系',
        problem: '复数 z=3+4i 对应的向',
        solution: '起点在原点，终点(3,4) 的向',
        key: '一一对应',
      },
    ],

...
export const A05: MathModel = {
  ...
  chapter: {
    ...
    examples: [
      {
        title: '求双曲线方程',
        problem: '已知焦点在x轴，a=3，b=4，求双曲线方程',
        solution: 'x²/9-y²/16=1',
        key: '标准方程',
      },
    ],

...
export const P03: MathModel = {
  ...
  chapter: {
    ...
    examples: [
      {
        title: '条件概率',
        problem: '袋中3白2黑球，不放回取两次，第一次白第二次黑的概率',
...
export const P04: MathModel = {
  ...
  chapter: {
    ...
    examples: [
      {
        title: '求期望',
        problem: '已知 X 的分布列P(X=1)=0.3, P(X=2)=0.7，求 E(X)',
...
export const P05: MathModel = {
  ...
  chapter: {
    ...
    subtitle: '独立重复试验',
    module: '概率与统计',
    content: '二项分布n次独立重复试验的分布',
    examples: [
      {
        title: '二项分布',
        problem: '10次硬币，恰有3次正面的概率',
        solution: 'P=C(10,3)(1/2)^10',
        key: '二项分布公式',
      },
    ],
    relatedConcepts: ['K66'],

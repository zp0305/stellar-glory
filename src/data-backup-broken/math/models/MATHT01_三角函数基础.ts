    ...
    examples: [
      {
        ...
        solution: 'c²=a²+b²-2ab cos C=9+16-2×3×4×1/2=13，c=3',
        key: '余弦定理',
      },
    ],
    relatedConcepts: ['K29'],
    ...
    examples: [
      {
        ...
        solution: 'cos θ=(a·b)/(|a||b|)=1/(1×)=/2，45°',
...
export const T06: MathModel = {
  ...
  chapter: {
    ...
    examples: [
      {
        title: '证明垂直',
        problem: '用向量法证明菱形对角线互相垂',
        solution: '设菱形对角线向量AC BD，则 AC·BD=0，故 AC⊥BD',
        key: '数量积为',
      },
    ],
    relatedConcepts: ['K34'],
